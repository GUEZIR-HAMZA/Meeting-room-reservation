...
public class SalleControllerTest {
    ...
    void testFindAll() throws Exception {
        ...
        List<Salle> salles = Arrays.asList(
                Salle.builder().numero("A1").climatisation(true).equipement("Projecteur").capacite(12).build(),
                Salle.builder().numero("A2").climatisation(false).equipement("Tableau blanc").capacite(8).build()
        );
    ...
    void testFindById() throws Exception {
        // Given
        Long salleId = 1L;
        Salle salle = Salle.builder().numero("A1").climatisation(true).equipement("Projecteur").capacite(12).build();
    ...
    void testSaveSalle() throws Exception {
        // Given
        Salle salleToSave = Salle.builder().numero("A3").climatisation(true).equipement("Tableau blanc").capacite(10).build();
        Salle salleToExpect = Salle.builder().numero("A3").climatisation(true).equipement("Tableau blanc").capacite(10).build();
